...
public class UserService {
   ...
   public User getUserWithAuthorities(String username) {
      return userRepository.findOneWithAuthoritiesByUsername(username).get();
   }
   ...
   public User getMyUserWithAuthorities() {
      ...
      optional = Optional.ofNullable(username).flatMap(userRepository::findOneWithAuthoritiesByUsername);
